...
pub(crate) struct ResolveContext<'a> {
    pub all_module_schemes: &'a HashMap<String, mondc::typecheck::TypeEnv>,
    pub module_type_decls: &'a HashMap<String, Vec<mondc::ast::TypeDecl>>,
    pub std_aliases: &'a HashMap<String, String>,
}

pub(crate) struct ResolvedImports {
    pub imports: HashMap<String, String>,
    pub imported_schemes: mondc::typecheck::TypeEnv,
    pub imported_type_decls: Vec<mondc::ast::TypeDecl>,
...
impl<'a> ResolveContext<'a> {
    pub(crate) fn resolve_for_source(
        ...
        let mut imported_schemes: mondc::typecheck::TypeEnv = HashMap::new();
